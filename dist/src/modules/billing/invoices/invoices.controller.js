...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({
        ...
        type: create_invoice_dto_1.CreateInvoiceDto,
    }),
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({ summary: 'Retrieve an invoice by ID' }),
    (0, swagger_1.ApiResponse)({
        status: common_1.HttpStatus.OK,
...
__decorate([
    ...
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    (0, swagger_1.ApiBearerAuth)('JWT-auth'),
    (0, swagger_1.ApiOperation)({ summary: 'Update an existing invoice' }),
    (0, swagger_1.ApiResponse)({
        status: common_1.HttpStatus.OK,
