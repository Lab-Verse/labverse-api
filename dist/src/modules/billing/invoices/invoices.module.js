...
const projects_module_1 = require("../../project-management/projects/projects.module");
const client_plan_quotations_module_1 = require("../../client-plan-quotations/client-plan-quotations.module");
...
exports.InvoicesModule = InvoicesModule = __decorate([
    (0, common_1.Module)({
        ...
        exports: [invoices_service_1.InvoicesService, typeorm_1.TypeOrmModule],
    })
], InvoicesModule);
